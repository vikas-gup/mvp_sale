...
define('frontend/models/deal', ['exports', 'ember-data'], function (exports, _emberData) {
  var dealModel;

  dealModel = _emberData['default'].Model.extend({
    title: _emberData['default'].attr('string'),
    description: _emberData['default'].attr('string'),
    publishDate: _emberData['default'].attr('date'),
    discountedPrice: _emberData['default'].attr('number'),
...
define('frontend/models/order', ['exports', 'ember-data'], function (exports, _emberData) {
  var orderModel;

  orderModel = _emberData['default'].Model.extend({
    user: _emberData['default'].belongsTo('user'),
    deal: _emberData['default'].belongsTo('deal'),
    orderDate: _emberData['default'].attr('date')
  });
...
define('frontend/routes/home', ['exports', 'ember'], function (exports, _ember) {
  ...
  signInRoute = _ember['default'].Route.extend({
    ...
    model: function model() {
      return this.store.findAll('deal');
    },
    setupController: function setupController(controller, model) {
      return controller.set('model', model.get('lastObject'));
    },
    actions: {
      ...
      buy: function buy(deal) {
        var order, status;
        status = confirm("Are you sure?");
        if (status === true) {
          order = this.controller.store.createRecord('order', {
            user: this.session.get('user'),
            deal: deal,
            orderDate: new Date()
          });
          return order.save().then(function (data) {
            return alert('Order successfully created...');
          }, function (error) {
...
define('frontend/routes/home/deal-create', ['exports', 'ember'], function (exports, _ember) {
  var dealCreateRoute;

  dealCreateRoute = _ember['default'].Route.extend({
    model: function model() {
      return [];
    },
    setupController: function setupController(controller, model) {
      var newDeal;
      newDeal = this.store.createRecord('deal', {
        title: null,
        description: null,
        price: null,
      ...
      return controller.set('newDeal', newDeal);
    },
    actions: {
      newDeal: function newDeal(_newDeal) {
        var publishDate;
        publishDate = new Date(this.controller.get('publishDate'));
        _newDeal.set('publishDate', publishDate);
        return _newDeal.save().then((function (_this) {
          return function (resp) {
            alert("Deal Created");
            _newDeal = _this.store.createRecord('deal', {
              title: null,
              description: null,
              price: null,
              discountedPrice: null,
            ...
            return _this.controller.set('newDeal', _newDeal);
          };
        })(this), function (error) {
          return alert('Deal could not be created...');
        });
      }
    }
  });

  exports['default'] = dealCreateRoute;
});
  ...
  exports["default"] = Ember.HTMLBars.template((function () {
    var child0 = (function () {
      return {
        ...
        buildFragment: function buildFragment(dom) {
          var el0 = dom.createDocumentFragment();
          var el1 = dom.createTextNode(" MVP Sale ");
          dom.appendChild(el0, el1);
          return el0;
        },
    ...
    var child2 = (function () {
      return {
        ...
        buildFragment: function buildFragment(dom) {
          ...
          dom.appendChild(el0, el1);
          var el1 = dom.createElement("div");
          dom.setAttribute(el1, "class", "card centered");
          dom.setAttribute(el1, "style", "width: 20rem;");
          var el2 = dom.createTextNode("\n            ");
          dom.appendChild(el1, el2);
          var el2 = dom.createElement("img");
          dom.setAttribute(el2, "class", "card-img-top");
          dom.appendChild(el1, el2);
          var el2 = dom.createTextNode("\n            ");
          dom.appendChild(el1, el2);
          ...
          var el3 = dom.createElement("p");
          dom.setAttribute(el3, "class", "card-text");
          var el4 = dom.createTextNode("Discounted Price: ");
          dom.appendChild(el3, el4);
          var el4 = dom.createComment("");
          dom.appendChild(el3, el4);
          dom.appendChild(el2, el3);
          ...
          var el4 = dom.createTextNode("Buy");
          dom.appendChild(el3, el4);
          dom.appendChild(el2, el3);
          var el3 = dom.createTextNode("\n            ");
          dom.appendChild(el2, el3);
        ...
        statements: [["attribute", "src", ["concat", [["get", "model.imagePath", ["loc", [null, [32, 45], [32, 60]]]]]]], ["content", "model.title", ["loc", [null, [34, 39], [34, 54]]]], ["content", "model.description", ["loc", [null, [35, 37], [35, 58]]]], ["content", "model.price", ["loc", [null, [36, 44], [36, 59]]]], ["content", "model.discountedPrice", ["loc", [null, [37, 55], [37, 80]]]], ["element", "action", ["buy", ["get", "model", ["loc", [null, [38, 58], [38, 63]]]]], [], ["loc", [null, [38, 43], [38, 65]]]]],
        locals: [],
        templates: []
      };
    })();
    var child3 = (function () {
      return {
        ...
        buildFragment: function buildFragment(dom) {
          var el0 = dom.createDocumentFragment();
          var el1 = dom.createTextNode("      No Deals For Today\n");
          dom.appendChild(el0, el1);
          return el0;
        },
        buildRenderNodes: function buildRenderNodes() {
    ...
    return {
      ...
      buildRenderNodes: function buildRenderNodes(dom, fragment, contextualElement) {
        ...
        var element5 = dom.childAt(element4, [7, 1, 1]);
        var element6 = dom.childAt(element5, [3]);
        var element7 = dom.childAt(element6, [3, 0]);
        var morphs = new Array(6);
        morphs[0] = dom.createMorphAt(dom.childAt(element4, [3, 3]), 1, 1);
      ...
      statements: [["block", "link-to", ["home"], [], 0, null, ["loc", [null, [11, 37], [11, 78]]]], ["content", "session.user.name", ["loc", [null, [18, 144], [18, 165]]]], ["block", "link-to", ["home.my-profile"], [], 1, null, ["loc", [null, [20, 28], [20, 80]]]], ["element", "action", ["logOut"], [], ["loc", [null, [21, 31], [21, 50]]]], ["block", "if", [["get", "model", ["loc", [null, [30, 10], [30, 15]]]]], [], 2, 3, ["loc", [null, [30, 4], [43, 11]]]], ["content", "outlet", ["loc", [null, [45, 0], [45, 10]]]]],
      locals: [],
      templates: [child0, child1, child2, child3]
    };
  })());
});
define("frontend/templates/home/deal-create", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    return {
      meta: {
        "fragmentReason": {
        ...
        "moduleName": "frontend/templates/home/deal-create.hbs"
      },
      isEmpty: false,
      arity: 0,
      cachedFragment: null,
      ...
      buildFragment: function buildFragment(dom) {
        ...
        var el5 = dom.createTextNode("New Deal ");
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("\n        ");
        dom.appendChild(el3, el4);
        ...
        dom.setAttribute(el5, "class", "cols-sm-2 control-label");
        var el6 = dom.createTextNode("Publish Date");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode("\n                ");
        dom.appendChild(el4, el5);
        ...
        dom.setAttribute(el5, "for", "username");
        dom.setAttribute(el5, "class", "cols-sm-2 control-label");
        var el6 = dom.createTextNode("Discounted Price");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode("\n                ");
        dom.appendChild(el4, el5);
      ...
      statements: [["inline", "input", [], ["type", "text", "class", "form-control", "name", "title", "id", "title", "placeholder", "Enter Title", "value", ["subexpr", "@mut", [["get", "newDeal.title", ["loc", [null, [15, 120], [15, 133]]]]], [], []]], ["loc", [null, [15, 22], [15, 135]]]], ["inline", "input", [], ["type", "text", "class", "form-control", "name", "description", "id", "description", "placeholder", "Enter Description", "value", ["subexpr", "@mut", [["get", "newDeal.description", ["loc", [null, [25, 138], [25, 157]]]]], [], []]], ["loc", [null, [25, 22], [25, 159]]]], ["inline", "input", [], ["type", "date", "class", "form-control", "placeholder", "Publish Date", "value", ["subexpr", "@mut", [["get", "publishDate", ["loc", [null, [35, 97], [35, 108]]]]], [], []]], ["loc", [null, [35, 22], [35, 110]]]], ["inline", "input", [], ["type", "text", "class", "form-control", "placeholder", "Enter Price", "value", ["subexpr", "@mut", [["get", "newDeal.price", ["loc", [null, [45, 96], [45, 109]]]]], [], []]], ["loc", [null, [45, 22], [45, 111]]]], ["inline", "input", [], ["type", "text", "class", "form-control", "placeholder", "Enter Discounted Price", "value", ["subexpr", "@mut", [["get", "newDeal.discountedPrice", ["loc", [null, [55, 107], [55, 130]]]]], [], []]], ["loc", [null, [55, 22], [55, 132]]]], ["inline", "input", [], ["type", "number", "class", "form-control", "placeholder", "Enter Quantity", "value", ["subexpr", "@mut", [["get", "newDeal.quantity", ["loc", [null, [65, 100], [65, 116]]]]], [], []]], ["loc", [null, [65, 22], [65, 118]]]], ["element", "action", ["newDeal", ["get", "newDeal", ["loc", [null, [71, 111], [71, 118]]]]], [], ["loc", [null, [71, 92], [71, 120]]]]],
      locals: [],
      templates: []
    };
  })());
